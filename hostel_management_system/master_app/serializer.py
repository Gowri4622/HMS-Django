...
class StudentSerializer(serializers.ModelSerializer):
    date_of_birth = serializers.DateField(format=settings.DATE_FORMAT, input_formats=[settings.DATE_FORMAT])
    check_in_date = serializers.DateField(format=settings.DATE_FORMAT, input_formats=[settings.DATE_FORMAT])

    class Meta:
        model = Student
        fields = ['id', 'first_name', 'last_name', 'register_number', 'gender', 'date_of_birth', 'contact_number',
                  'email', 'parents_number', 'blood_group', 'department', 'room_number','room_type','room_assets','check_in_date', 'hostel']
...
class RoomSerializer(serializers.ModelSerializer):
    class Meta:
        model = Room
        fields = ['hostel','room_number', 'room_type', 'room_assets']
